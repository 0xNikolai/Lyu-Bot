...
module.exports = new Event("ready", async bot => {
    ...
    setTimeout(async () => {
        ...
        const activités = ["lyuOS", "dev", "0xNikolai", `${bot.users.cache.size} utilisateurs`, `${bot.guilds.cache.size} serveurs`]
    ...
    let channel = bot.channels.cache.get("925978591039201280")
